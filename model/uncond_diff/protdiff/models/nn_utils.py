...
def latent_loss(pred_latent, true_latent, single_mask, weight=None):
    latent_loss_dict = {}
    ...
    latent_loss_dict['latent_mse_loss'] = torch.sum(latent_single_error) / (torch.sum(latent_single_mask) + 1e-6)
