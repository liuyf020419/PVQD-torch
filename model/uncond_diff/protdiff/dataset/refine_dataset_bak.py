...
import sys
sys.path.append("/train14/superbrain/yfliu25/structure_refine/PriorDiff/protdiff/models")
...
class ProtDiffDataset(BaseDataset):
    def __init__(self, config, data_list, train=True, pdbroot=None, noising_mode=None, validate=False):
        super().__init__()
