...
def make_coords4_from_coords5(coords5):
    return np.concatenate([coords5[:, :3], coords5[:, -1][:, None]], 1)
...
def remake_atom4_from_atom5(atom5_coords):
    assert len(atom5_coords.shape) == 3
    n_ca_c_coords = atom5_coords[:, :3]
    o_coords = atom5_coords[:, -1]
    return np.concatenate([n_ca_c_coords, o_coords[:, None]], 1)
...
if __name__ == "__main__":
    ...
    pdbfile = '/home/liuyf/proteins/mc_vq_20230919/experiment/monomer_folding/AdK_pdb/AdK_unbind.pdb'
